    ...
    return (
      <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
        ...
        <div className="fixed inset-0 -z-10">
          ...
          <div
            className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="w-full max-w-sm z-10">
          <div className="glass-lg backdrop-blur-2xl rounded-2xl p-8 shadow-2xl text-center">
            ...
            <p className="text-white/60 text-sm">Your account has been created successfully!</p>
            <p className="text-white/60 text-sm mt-4">You can now login with your credentials</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-lg backdrop-blur-2xl rounded-2xl p-8 shadow-2xl animate-slideInUp">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            {/* Submit button */}
            <button type="submit" disabled={loading} className="btn-primary w-full mt-6 text-sm">
              {loading ? (
